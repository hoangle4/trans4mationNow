		...
		<Fragment>
			<div className="row mx-0">
				<div className="col-12 px-0">
					<Jumbotron title="Resources Page" subtitle="Learn about G.E.Ms with these in-depth resources" />
				</div>
			</div>
				...
				<div className="container">
					<div className="row mx-0 justify-content-center">
						...
						<ResouceItem
							...
							groupItem={[
								{
									desc: 'Search for a grandparent support group in your area -- Provided by AARP.',
						...
						<ResouceItem
							...
							groupItem={[
								...
								},
								{
									...
									link: 'https://www.ohiograndparentkinship.org/documents/Power-of-Attorney_2018.pdf'
								},
								{
								...
								},
								{
									...
									link: 'https://www.congress.gov/bill/115th-congress/senate-bill/1091/text'
								}
							]}
						/>
						...
						<ResouceItem
							...
							groupItem={[
								...
								},
								{
									...
									link: 'http://www.raisingyourgrandchildren.com/Financial_Assistance.htm'
								},
								{
									desc:
						...
						<ResouceItem
							...
							groupItem={[
								{
									desc: 'Emergency Assistance Paying Bills – Charity and Community Organizations. ',
									link: 'https://freefinancialhelp.net/grandparents-raising-grandchildren-resources/'
								},
								{
									desc: 'Finance. ',
									link: [
